...
import { CameraSilhouette } from "@/components/CameraSilhouette";
                ...
                <div className="grid gap-3 sm:grid-cols-2">
                  <div className="space-y-2">
                    <div className="relative flex aspect-[3/4] items-center justify-center overflow-hidden rounded-2xl border bg-secondary text-center shadow-inner">
                      {frontPreview ? <><img src={frontPreview} alt="Preview da foto frontal para análise de medidas" className="h-full w-full object-cover" /><PosturalGrid variant="front" label="Frente" /><span className="absolute bottom-3 left-1/2 z-20 -translate-x-1/2 rounded-full bg-card/90 px-3 py-1 text-xs font-bold">Preview frente</span></> : <><PosturalGrid variant="front" label="Frente" /><CameraSilhouette variant="front" className="absolute inset-0 w-full h-full text-primary/50 z-10" /><span className="absolute bottom-4 left-1/2 z-20 -translate-x-1/2 rounded-full bg-card/90 px-3 py-1.5 text-[11px] font-bold text-center">Alinhe seu corpo<br/>com a silhueta</span></>}
                    </div>
                  ...
                  <div className="space-y-2">
                    <div className="relative flex aspect-[3/4] items-center justify-center overflow-hidden rounded-2xl border bg-secondary text-center shadow-inner">
                      {sidePreview ? <><img src={sidePreview} alt="Preview da foto lateral para análise de medidas" className="h-full w-full object-cover" /><PosturalGrid variant="side" label="Lateral" /><span className="absolute bottom-3 left-1/2 z-20 -translate-x-1/2 rounded-full bg-card/90 px-3 py-1 text-xs font-bold">Preview lateral</span></> : <><PosturalGrid variant="side" label="Lateral" /><CameraSilhouette variant="side" className="absolute inset-0 w-full h-full text-accent/50 z-10" /><span className="absolute bottom-4 left-1/2 z-20 -translate-x-1/2 rounded-full bg-card/90 px-3 py-1.5 text-[11px] font-bold text-center">Perfil 90°<br/>ombros alinhados</span></>}
                    </div>
                    <div className="grid grid-cols-2 gap-2">
